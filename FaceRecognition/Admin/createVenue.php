...
<head>
  ...
  <link href="img/logo/CCIT.png" rel="icon">
 ...
 <div class="rooms">
                <div class="title">
                    ...
                    <div class="rooms--right--btns">
                        ...
                        <button id="addClass1" class="add"><i class="ri-add-line"></i>Add Room</button>
                    </div>
                </div>
                <div class="rooms--cards">
                    <a href="#" class="room--card">
                        <div class="img--box--cover">
                            <div class="img--box">
                            <img src="img/CC101.jpg" alt="">
                            </div>
                        </div>
                        <p class="free">Computer Lab 1</p>
                    </a>
                    <a href="#" class="room--card">
                        <div class="img--box--cover">
                            <div class="img--box">
                            <img src="img/CC204.jpg" alt="">
                            </div>
                        </div>
                        <p class="free">Computer Lab 2</p>
                    </a>
                    
                    <a href="#" class="room--card">
                        <div class="img--box--cover">
                            <div class="img--box">
                                <img src="img/CC205.jpg" alt="">
                            </div>
                        </div>
                        <p class="free">Computer Lab 3</p>
                    </a>
                   
                    <a href="#" class="room--card">
                        <div class="img--box--cover">
                            <div class="img--box">
                            <img src="img/CC203.jpg" alt="">
                            </div>
                        </div>
                        <p class="free">Classroom 1</p>
                    </a>
                    <a href="#" class="room--card">
                        <div class="img--box--cover">
                            <div class="img--box">
                            <img src="img/CC206.jpg" alt="">
                            </div>
                        </div>
                        <p class="free">Classroom 2</p>
                    </a>
                </div>
            </div>
